...
import com.sjw.mygreendao.application.MyApplication;
import com.sjw.mygreendao.daobean.User;
import com.sjw.mygreendao.greendao.DaoSession;
...
//        return userDao.queryBuilder().list();
    ...
    public List<User> searchByConditionUser(String userName) {
        ...
        return daoSession.getUserDao().queryBuilder().where(UserDao.Properties.UserName.like(userName)).list();
    }
